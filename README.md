...
The third key finding is that the period from 2020 to 2023 shows the most dramatic affordability gap in the entire timeline. During the COVID-19 pandemic, several factors converged to push home prices upward very quickly. Historically low interest rates made borrowing cheaper, remote work allowed people to move to new locations, and housing inventory shortages limited supply. Increased buyer competition combined with supply issues drove prices up substantially. Behavioral factors such as fear of missing out, expectations of permanent remote work, and investor interest in single-family rentals also contributed to price escalation. At the same time, median household income did increase but nowhere near the same magnitude. This led to the steepest divergence between housing prices and income seen in the dataset, suggesting that affordability has become more constrained than ever. 

Looking at specific historical events further supports these observations. Around 2006, the United States entered a housing bubble as expanding access to mortgage credit, the rise of subprime lending, and financial innovations such as mortgage-backed securities made borrowing easier. Low interest rates following the 2001 recession further stimulated demand, increasing home prices. The graph clearly shows a steep rise in MSPUS during this period. Following that, the financial crisis of 2008 caused a significant crash in home prices. The visualization reflects this drop around 2008–2011, while income did not fall nearly as dramatically. After the crisis, prices eventually recovered and continued rising, but incomes remained comparatively flat. Supply shortages, slow new construction following the recession, and increased investor activity in the single-family market pushed prices upward even before the pandemic. These conditions set up the very large affordability problems seen during the pandemic, when low interest rates, remote work, and low housing inventory caused home prices to rise much faster than household income.

Overall, the graph demonstrates that wage growth has not kept pace with housing costs. Incomes move upward in a gradual line, while home prices form a much steeper trajectory. Even without adjusting for inflation, the nominal comparison supports the conclusion that housing affordability has deteriorated over time. For average households, buying a home has become increasingly less attainable, particularly for younger generations who entered the housing market during periods of high price levels and limited wage growth. These findings align with widespread public concerns about housing affordability and provide visual evidence of long term economic imbalance in the United States housing market.Rising home values create intergenerational wealth disparities. Households that owned homes before major price surges accumulated substantial equity, while first-time buyers faced higher barriers to entry which lead to long-term inequality in wealth building opportunities. These patterns also suggest broader policy implications, as stagnating wages paired with rapid home price growth may require targeted interventions such as supply-side expansion, wage policy adjustments, or affordability programs to reduce the structural barriers to homeownership. 

## Future Work
There are several directions that future work could take to extend the analysis presented in this project. One important improvement would be adjusting both home prices and median household income for inflation. Because both datasets are expressed in nominal dollars, long-term comparisons can be affected by changes in purchasing power and overall price levels. Using CPI-U (Consumer Price Index for All Urban Consumers) would allow us to convert both series into real dollars, providing a clearer picture of affordability that reflects actual economic conditions rather than nominal growth. Inflation adjustment would also help evaluate whether real incomes have kept pace with rising housing costs once broader price changes are considered.

Another valuable extension would be calculating a formal affordability ratio, such as dividing median sales price by median household income or comparing estimated mortgage payments to income levels. This would create a single metric that tracks affordability over time and summarizes how homeownership difficulty has changed. Because affordability ratios are widely used in economic and housing policy research, incorporating one would also make our findings more comparable to external studies.

The analysis could also be expanded geographically. Both datasets used in this project are national averages, which simplifies interpretation but masks important regional and metropolitan differences. Housing markets in major cities such as San Francisco, New York, and Austin operate very differently from national trends, and income levels vary significantly across states. Incorporating regional or state-level data would help identify where affordability challenges are most severe and how local factors contribute to housing inequality.

Demographic extensions could also provide insight into generational and socioeconomic effects. Research shows that younger generations face greater barriers to homeownership due to slower wage growth and higher entry-level housing prices. Examining demographic groups such as age, income bracket, or first-time homebuyers could reveal how affordability changes impact different populations unequally and connect the analysis more closely to public policy discussions.

Another area of future work involves forecasting. Time-series models could project future home prices and income levels and estimate how affordability may evolve under different economic scenarios. Forecasting could incorporate variables such as interest rates, construction costs, employment trends, and demographic shifts, offering useful context for policymakers and households planning long-term decisions.

Beyond these extensions, future work could examine broader structural forces that help explain why housing prices and incomes have diverged. Distinguishing between land value appreciation and structure value, for example, would clarify whether affordability challenges stem primarily from rising demand for scarce land. Analyzing supply-side constraints—including restrictive zoning, declining post-2008 construction levels, and shortages of developable land—could further illuminate how limited housing supply intensifies price pressures. Incorporating migration patterns, such as the pandemic-era movement into smaller metros, would help explain how regional population shifts create new affordability challenges.

Future work could also integrate financial and behavioral factors that influence housing demand independently of income trends. The growing presence of institutional investors in single-family home purchases may reduce available supply for owner-occupants and contribute to faster price escalation in certain markets. Examining changes in lending standards and credit accessibility across economic cycles would clarify how borrowing constraints affect who can enter the housing market. Broader measures of inequality—such as the productivity–wage gap and generational differences in wealth accumulation—could also deepen our understanding of long-term homeownership barriers.

Finally, expanding the dataset to include mortgage rates, housing inventory, or new construction activity could help explain why prices rise even when incomes do not. Incorporating established measures such as the NAHB/Wells Fargo Housing Affordability Index (HAI) would also allow us to benchmark our findings against industry-recognized metrics. A more comprehensive dataset would strengthen our understanding of the drivers behind long-term housing market changes and provide a more complete picture of affordability in the United States.
